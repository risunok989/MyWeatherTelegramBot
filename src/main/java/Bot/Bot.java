...
//        return botSettings.getTokenBot();
        return "5010755474:AAGlTHFpfzE93HKn551tCYZ9MsCtaOJT_ME";
    }

    public static String getTokenWeather() {
//        return botSettings.getTokenWeather();
        return "&appid=7f9c8827806a797d89d37d20a9152291";
    }
...
//        id2 = update.getMessage().getChat().getLinkedChatId();
        String u =
...
//        System.out.println(update.getMessage().getMessageId().toString());
        ...
        System.out.println("first_name " + first_name + " last_name " + last_name +
                " username" + username);
        sendMessage(update.getMessage().getChatId(),"first_name: " + first_name + ", "
                + " last_name: " + last_name + ", " +
                " username: " + username +", " + " getId(): " + id);

        // first_name фамилия
        // last_name имя
        // username имя пользователя (t.me...)
        //
    }
    public void testMessage (Message message){
        String ms = message.getText();
        sendMessage(message.getChatId(), ms );
    }
}
